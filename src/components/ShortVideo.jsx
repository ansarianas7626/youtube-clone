        ...
        <div className='flex flex-col-reverse h-full w-[50%] px-8'>
          <div className='space-y-4'>
            <div className='flex items-center space-x-3'>
              ...
              <span className='font-semibold'>@dustylumberco</span>
              <button className='text-sm bg-black text-white rounded-full px-3 py-2 font-semibold'>Subscribe</button>
            </div>

            <p className='text-3xl w-full font-bold tracking-tight'>Freud finger joint bit and I definitely used way too much glue</p>
            ...
            <div className='flex space-x-5'>
              <div className='flex flex-col items-center'>
                ...
                <span className='font-semibold text-sm pt-1'>2.9M</span>
              </div>
              ...
              <div className='flex flex-col items-center'>
                ...
                <span className='font-semibold text-sm pt-1'>Dislike</span>
              </div>
              <div className='flex flex-col items-center'>
                ...
                <span className='font-semibold text-sm pt-1'>8.1K</span>
              </div>
              <div className='flex flex-col items-center'>
                ...
                <span className='font-semibold text-sm pt-1'>Share</span>
              </div>
